...
public class Devs4jProducer {
    ...
    public static void main(String[] args) {
        ...
        try (Producer<String, String> producer = new KafkaProducer<String, String>(props);) {
            for (int i = 0; i < 100; i++) {
                RecordMetadata recordMetadata = producer.send(new ProducerRecord<>("devs4j-topic", "devs4j-key", String.valueOf(i))).get();
                log.info("Topic = {} , Partition = {} , Offset = {} , Thread = {} ", recordMetadata.topic(),recordMetadata.partition(),recordMetadata.offset(), Thread.currentThread().getName());
            }
            producer.flush();
